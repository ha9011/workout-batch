...
import com.example.workout.repository.booking.BookingEntity;
import com.example.workout.repository.booking.BookingStatus;
import com.example.workout.repository.notification.NotificationEntity;
import com.example.workout.repository.notification.NotificationEvent;
import com.example.workout.repository.notification.NotificationModelMapper;
...
public class SendNotificationBeforeClassJobConfig {
     ...
     * // 업데이트 하는 요소가 없어서 cursor를 사용하지 않음
     */
    @Bean
